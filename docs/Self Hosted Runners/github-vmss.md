...
This documentation shows you how to configure an Azure Virtual Machine Scale Set (VMSS) with the latest Amesto Fortytwo Self Hosted Runner image, and connecting the VMSS instances to GitHub. 
