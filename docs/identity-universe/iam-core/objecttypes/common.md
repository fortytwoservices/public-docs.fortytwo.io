...
| joinScope | The join scope used by [sync rules](../syncrules.md)|
| anchor1 | Generic anchor useful for synchronizing objects |
| anchor2 | Generic anchor useful for synchronizing objects |
| anchor3 | Generic anchor useful for synchronizing objects |
| anchor4 | Generic anchor useful for synchronizing objects |
| anchor5 | Generic anchor useful for synchronizing objects |
| anchor6 | Generic anchor useful for synchronizing objects |
| anchor7 | Generic anchor useful for synchronizing objects |
